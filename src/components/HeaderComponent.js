...
import { Navbar, Label, Input } from 'reactstrap';
import { NavbarBrand, Nav, NavbarToggler, Collapse, NavItem, Jumbotron, Button, Modal, ModalHeader, ModalBody, FormGroup, Form } from 'reactstrap';
...
class Header extends Component {
    ...
    render() {
        return (
            //Is used to group different components in the same render
            <React.Fragment>  
                        ...
                        <Form onSubmit={this.handleLogin}>
                            <FormGroup>
                                ...
                                <Input type="text" id="username" name="username"
                                    //Setting the value of the field in the DOM by the name "username"
